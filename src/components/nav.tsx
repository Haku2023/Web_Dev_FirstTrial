...
import house from "../assets/haunted-house.png";
...
function Nav() {
  ...
  return (
    ...
    >
      ...
      <nav className=" flex  flex-row mt-2 justify-center w-full">
        <div className="flex justify-center flex-1 ">
          {!clicked ? (
            ...
            <Link
              className="bg-amber-200 mx-3 py-2 px-4  rounded-4xl hover:bg-amber-700 hover:text-amber-50  text-black flex flex-row"
              to="/"
              onClick={() => {
                setClicked(false);
              }}
            >
              ...
              <img src={house} alt="witches" className="max-h-6.5 mr-2" />
              <span className="text-base font-bold lg:text-2xl font-[Butcherman]">
                Home
              </span>
            </Link>
